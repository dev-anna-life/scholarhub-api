...
function getTransporter() {
  ...
  const user = process.env.EMAIL_USER || 'scholarhubng1@gmail.com'
  const pass = (process.env.EMAIL_PASS && process.env.EMAIL_PASS.length > 5 && !process.env.EMAIL_PASS.includes('zaew'))
